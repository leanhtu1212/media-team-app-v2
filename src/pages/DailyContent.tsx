  ...
  const toggleItem = async (id: string) => {
    ...
    if (it.done) {
      ...
      await saveItems(items.map((i) => {
        ...
        const updated: ContentItem = { ...base, done: true, doneDate: today };
        if (reportId) updated.reportId = reportId;
        return updated;
      }), 'Đã cập nhật');
    }
  };
